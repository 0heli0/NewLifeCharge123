...
@Setter
@ApiModel
public class NewLifeSpendLogBillOut {
    ...
    //操作金额/消费金额
    @ApiModelProperty(value = "操作金额/消费金额/金额")
    ...
    //桩站历史未结算金额/之前未结算金额
    @ApiModelProperty(value = "桩站历史未结算金额/之前未结算金额")
    private BigDecimal stationOldNoCheckAmount;

    //桩站未结算金额/未结算金额
    @ApiModelProperty(value = "桩站未结算金额/未结算金额")
    ...
    //桩站历史余额/之前账户余额
    @ApiModelProperty(value = "桩站历史余额/之前账户余额")
    private BigDecimal stationOldBalance;

    //桩站余额/账户余额
    @ApiModelProperty(value = "桩站余额/账户余额")
