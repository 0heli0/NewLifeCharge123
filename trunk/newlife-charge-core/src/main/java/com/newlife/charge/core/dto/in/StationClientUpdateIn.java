...
@Getter
@ApiModel
public class StationClientUpdateIn {

    //充电桩主键ID
    @ApiModelProperty(value = "充电桩主键ID，必传")
    @NotNull(message = "充电桩主键ID不能为空")
    private Integer id;
...
//    //充电桩编号，后台自动生成，不能修改
//    @ApiModelProperty(value = "充电桩编号，后台自动生成，不能修改")
//    private String code;

//    //充电桩终端号
//    @ApiModelProperty(value = "充电桩终端号，必传,最长50位")
//    @NotBlank(message = "请填写充电桩终端号")
//    @Length(max = 50, message = "充电桩终端号长度最长50位")
