...
public interface WebSocketChargeService {
     ...
     * @return
     */
    ChargeBeginOut sendRealTimeMessage(Integer gunId, Integer status, PileRealTimeDataIn pileRealTimeDataIn);
     ...
     * @return
     */
    PlugInGunOut plugInGun(Integer id, Integer status, PileRealTimeDataIn pileRealTimeDataIn);

    /**
     * 充电枪停止操作后操作
     * @param pileHistoryDataIn 硬件传的数据
     */
    ChargeEndOut chargeStopSuccess(PileHistoryDataIn pileHistoryDataIn);
}
